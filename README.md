...
rz -y
# 4、上服务器解压
tar -zxvf govueblog-2022.tar.gz
# 5、部署服务（后台运行）
sh build/startup.sh
# 6、守护进程（supervisor）
[program:go-vue-blog]
directory = /data/modules/go-vue-blog
command = /data/modules/go-vue-blog/govueblog -c configs/config.yml
autostart = true
autorestart = true
startsecs = 5
user = root
redirect_stderr = true
stdout_logfile = /data/modules/go-vue-blog/supervisor.log
